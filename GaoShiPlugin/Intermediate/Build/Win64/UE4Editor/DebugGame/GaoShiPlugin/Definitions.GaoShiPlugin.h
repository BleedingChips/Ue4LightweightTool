...
#define ORIGINAL_FILE_NAME "UE4Editor-GaoShiPlugin-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME PluginTesting
#define DEPRECATED_FORGAME DEPRECATED
#define GAOSHIPLUGIN_API DLLEXPORT
#define WITH_PHYSX 1
#define WITH_APEX 1
